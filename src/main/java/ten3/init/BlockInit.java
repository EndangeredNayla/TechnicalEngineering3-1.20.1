...
public class BlockInit
{
    ...
    public static void regAll()
    {
        ...
        */
        ...
        regCable("cable", MapColor.ICE, SoundType.GLASS);
        regCable("cable_quartz", MapColor.STONE, SoundType.STONE);
        regCable("cable_azure", MapColor.METAL, SoundType.METAL);
        regCable("cable_star", MapColor.ICE, SoundType.GLASS);
        regPipe("pipe", MapColor.METAL, SoundType.METAL);
        regPipe("pipe_white", MapColor.METAL, SoundType.METAL);
        regPipe("pipe_black", MapColor.METAL, SoundType.METAL);
        regCell("cell", MapColor.ICE, SoundType.GLASS);
    ...
    public static void regCell(String id, MapColor m, SoundType s)
    {
        regBlock(id, () -> new Cell(m, s, id, false));
    }

    public static void regCable(String id, MapColor m, SoundType s)
    {
        regBlock(id, () -> new CableBased(m, s, id));
    }

    public static void regPipe(String id, MapColor m, SoundType s)
    {
